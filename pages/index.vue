  ...
  <div>
    <UContainer>
      <div class="mt-10 flex flex-col gap-10">
        ...
        <div class="flex flex-col border border-gray-200 dark:border-gray-800 rounded-xl" v-if="products.length > 0">
          <div class="shadow p-4 rounded-xl rounded-b-none bg-primary text-white">
            جدید ترین محصولات
          </div>
          <UCarousel :items="products.slice(0, 8)"
...
await productStore.getSearch("new")
const { categories_tags, products } = storeToRefs(productStore)
